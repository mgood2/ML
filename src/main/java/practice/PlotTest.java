...
public class PlotTest {
    ...
    public static void main(String[] args) {
        ...
        final RewardFunction rf = new GoalBasedRF(
                new TFGoalCondition(tf), 5.0, -0.1
        );
        ...
        final SimpleHashableStateFactory hashFactory = new SimpleHashableStateFactory();
        ...
        LearningAgentFactory qLearningFactory = new LearningAgentFactory() {
            ...
            public LearningAgent generateAgent() {
                return new QLearning(domain, 0.99, hashFactory, 0.3, 0.1);
            }
        };
